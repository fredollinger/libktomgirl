...
{
public:
  typedef std::auto_ptr <DynamicNoteTag> Ptr;
  typedef  std::auto_ptr <const DynamicNoteTag> ConstPtr;
...
{
public:
  typedef std::auto_ptr <DepthNoteTag> Ptr;
...
{
public:
  typedef std::auto_ptr <NoteTagTable> Ptr;
  //typedef sigc::slot<DynamicNoteTag::Ptr> Factory;

  static const NoteTagTable::Ptr & instance() 
    {
      static NoteTagTable::Ptr s_instance = NoteTagTable::Ptr(new NoteTagTable);
      return s_instance;
    }
  //static bool tag_is_serializable(const std::auto_ptr<const Gtk::TextTag> & );
  //static bool tag_is_growable(const std::auto_ptr<Gtk::TextTag> & );
